...
def save_file(file) :
  ...
  if file and allowed_file(file.filename) :
    # ex> ../../test.jpg -> test.jpg 로 변환하기 위해 secure_filename 사용
    ...
    relative_path = os.path.join(
      ...
      randomword(5), # static/user_images/{user_id}/memos/랜덤해쉬값(5자리)
      filename  # static/user_images/{user_id}/memos/랜덤해쉬값(5자리)/파일명
    )
